        ...
        <div className="container-xl navside">
          <div className="row py-3 align-items-center">
            ...
            <div className="col-1 col-md-7">
              <nav className="mt-2">
                <ul className="drop">
                  ...
                  <li className="dropli"><NavLink to="/theme">Premium Themes</NavLink>
                    <div className="dropdown shadow rounded py-3">
                      <ul>
                        <li><NavLink to="/category/Populartheme">Popular Items </NavLink></li>
                        <li><NavLink to="/category/Blog">Blog / Magazine </NavLink></li>
                        <li><NavLink to="/category/Entertainment">Entertainment </NavLink></li>
                      </ul>
                      <ul>

                        <li><NavLink to="/category/Real_Estate">Real Estate </NavLink></li>
                        <li><NavLink to="/category/Nonprofit">Nonprofit </NavLink></li>
                        <li><NavLink to="/category/Corporate">Corporate </NavLink></li>
                      </ul>
                      <ul>
                        <li><NavLink to="/category/Creative">Creative </NavLink></li>
                        <li><NavLink to="/category/Wedding">Wedding </NavLink></li>
                        <li><NavLink to="/category/BuddyPress">BuddyPress </NavLink></li>
                      </ul>
                    </div></li>
            ...
            <div className="col-3 col-md-2 text-right">
              ...
              <button className="togglebtn" onClick={() => setStatus(true)}><i className="fas fa-bars"></i></button>
            </div>
          </div>
        </div>
          {
            status ? <div className="togglenav">
              <div className="toggleside">
                ...
                <ul className="sidenav">
                  ...
                  <li><NavLink to="/hosting">Top 10 Wordpress Hosting Providers</NavLink></li>
                  <li className="sideli" onClick={() => setNavStaus(!navstaus)}><NavLink to="/theme">Premium Themes</NavLink>
                    {
                      navstaus ? <div className="dropside py-3">
                          <ul>
                            <li><NavLink to="/category/Populartheme">Popular Items </NavLink></li>
                            <li><NavLink to="/category/Blog">Blog / Magazine </NavLink></li>
                            <li><NavLink to="/category/Entertainment">Entertainment </NavLink></li>
