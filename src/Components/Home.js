        ...
        <>
            ...
            <div className="themeCard">
                <div className="container-xl">
                    <div className="row">
                        <h3 className="double_cirlcle">Best Premium WordPress Themes Providers 2021</h3>
                        <div className="row">
                            <div className="col-md-6 col-lg-3 col-6 mt-5">
                                <div className="cards shadow p-2 py-3 rounded text-center">
                                    ...
                                    <h5 className="text-left">51,345 WordPress Themes & Website Templates From $2</h5>
                                    <p className="text-left">WordPress themes, web templates and more. Brought to you by the largest global community of creatives.</p>
                                    </div>
                                    <button className=" text-light py-2 px-4 border-0">Visit ThemeForest</button>
                                </div>
                            </div>
                            <div className="col-md-6 col-lg-3 col-6 mt-5">
                                <div className="cards shadow p-2 py-3 rounded text-center">
                                    ...
                                    <p className="text-warning"><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i></p>
                                    <div className="thetext">
                                    <h5 className="text-left">The Full Suite of Thrive Themes Plugins & Build Beautiful Websites & Landing Pages.</h5>
                                    <p className="text-left">Get Free Feature Updates. Premium Templates. Friendly Support Team.</p>
                                    </div>
                                    <button className=" text-light py-2 px-4 border-0">Visit ThemeForest</button>
                                </div>
                            </div>
                            <div className="col-md-6 col-lg-3  col-6 mt-5">
                                <div className="cards shadow p-2 py-3 rounded text-center">
                                    ...
                                    <p className="text-warning"><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i></p>
                                   <div className="thetext">
                                    <h5 className="text-left">The Most Popular WordPress Themes In The World And The Ultimate Visual Page Builder</h5>
                                    <p className="text-left">Join 767,154 Empowered Web Design Professionals & Business Owners</p>
                                   </div>
                                    <button className=" text-light py-2 px-4 border-0">Visit ThemeForest</button>
                                </div>
                            </div>
                            <div className="col-md-6 col-lg-3  col-6 mt-5">
                                <div className="cards shadow p-2 py-3 rounded text-center">
                                   ...
                                   <div className="thetext">
                                    <h5 className="text-left">Premium WordPress Themes & Plugins</h5>
                                    <p className="text-left">Since 2010, 102,245+ customers make beautifully responsive WordPress sites, faster and easier than ever.</p>
                                   </div>
                                    <button className=" text-light py-2 px-4 border-0">Visit ThemeForest</button>
                                </div>
                            </div>
            ...
            <div className="wrap-2">
                <div className="container-xl">
                    <div className="text">
                        <h3 className="double_cirlcle mt-4">2021’s Best Selling WordPress Themes</h3>
                    </div>
                    <div className="cardbtn mt-5">
                        <button className="btn btn-outline-danger m-2">Popular Items</button>
                        <button className="btn btn-outline-danger m-2">Blog / magazine</button>
                        <button className="btn btn-outline-danger m-2">Entertainment</button>
                    ...
                    <div className="wordpressthemes">
                        <div className="row mt-4">
                            {
                                wordpresstheme.map((cur,ind) => {
                                    return (
                                        <div className="col-md-6 col-lg-4 col-12 mt-3 hoverefect" key={ind}>
                                            <div className="card shadow overflow-hidden">
                                            <div className="imghover position-relative">
                                                <img src={cur.img} alt="" className="img-fluid" />
                                                ...
                                                <div className="Card_text p-2 hoveer">
                                                    ...
                                                    <p className="author">by <span>{cur.author}</span></p>
                                                    <div className="row mt-5">
                                                        <div className="col-md-4 col-3">
                                                            <button className="btn btn-secondary detailsbtn">Details</button>
                                                        </div>
                                                        <div className="col-md-8 col-9 text-right position-relative">
                                                            <button className="btn btn-danger mx-2 downloadbtn">Download</button>
                                                            <button className="btn btn-info demobtn">Demo</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <button className="btn btn-danger mt-3 loadbtn">Load More...</button>
                    </div>
                </div>
            </div>
            ...
            <div className="wrap-3">
                <div className="container-xl">
                    <h2 className="mt-5 font-weight-bold">Top WordPress Theme Providers 2021 Is So Famous, But Why?</h2>
                    <p className="font-weight-900">A website is a powerful online marketing tool that you can use to promote your business on the internet. A few years ago building a website for a small or large company was expensive and distressing. However, thanks to free tools like WordPress, creating a corporate website is easy and fast today. WordPress has a large number of specific themes or templates for companies and corporations that will go very well for your business.
                    There are impressive custom-made WordPress themes for companies that provide all the features and functionalities you may need to promote and manage your business online. Picking the correct WordPress template for your commercial is not problematic if you know how to search. A corporate website is not only a means to present your business online, having a contact form will help your clients to contact you, and showing information about your location is also essential. Finally, it is a good idea to have a flexible design that allows you to redesign your website in the future.
                    If you are not sure if any of these fantastic WordPress themes are suitable for your web project, we have published some other collections of WordPress themes that could better fit what you need.</p>
                    <p className="mt-4"><strong>What a good WordPress theme should have</strong></p>
                    <ul className="listIcons">
                        ...
                        <li>Be responsive so that both mobile and desktop users have a good experience.</li>
